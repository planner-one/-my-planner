...
_현재 기준: v0.3.17 UI System Pass · v0.3.18은 미릴리즈 · SC-17 코드·집중 검증 완료, 로그인·터치·성능 QA 대기_
...
| v0.3.18 | Planner Flow Clarity | 신규 사용자 온보딩, 플래너 역할 구분, 대시보드 배치 안정화 | 진행 중·미릴리즈, SC-17 구현·로그인 QA 대기 |
...
### SC-17 대시보드 배치 안정화 — 코드·집중 검사 완료, 로그인 QA 대기
...
- 현재 상태는 코드·집중 검증 완료이며 커밋·push·운영 배포로 기록하지 않음
...
1. SC-17 사용자 피드백 확인과 미커밋 변경 범위 검토
2. 로그인 Firestore 저장·실패·새로고침·다중 탭 QA
