...
| v0.3.18 | Planner Flow Clarity | 신규 사용자 온보딩과 Todo/작업/프로젝트/목표/오늘 방향 역할을 더 선명하게 연결 | 진행 중·미릴리즈, SC-10 운영 반영·로그인 QA 대기 |
...
1. 모바일 390px, 태블릿 768/1024px 로그인 세션에서 SC-10 하단 메뉴·편집·테마·밀도와 SC-16 온보딩 육안 QA
2. SC-10 바로가기 저장·즉시 반영·포커스 복귀와 SC-16 완료·건너뛰기·저장 실패 재시도·계정 전환 확인
3. 실제 기기 주소창이 열린 첫 화면과 키보드가 열린 긴 폼 스크롤 확인
4. v0.3.18 Planner Flow Clarity의 목표/프로젝트/작업/오늘 방향 역할 정리
5. v0.3.19 Data Quality & AI Readiness로 상태 이력, 통합 검색, 데이터 내보내기 범위 정리
6. v0.4.0 운영 Reader API 설계 여부 결정
