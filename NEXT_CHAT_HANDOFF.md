...
_작성일: 2026-06-28_
_갱신일: 2026-07-01 (v0.3.5 Job Content Parsing 보강 기준)_
...
- 현재 앱 버전: `v0.3.5 Job Content Parsing`
- 현재 로컬 브랜치 상태: v0.3.5 Job Content Parsing 커밋/푸시 완료 기준
